...
static irqreturn_t irq_handler(int irq, void* dev_id)
{
	...
	printk(KERN_INFO "Keyboard: interrupt occurred %lu\n",chr_spinlock_variable);
...
static int __init chr_driver_init(void)
{
	...
	if(tasklet == NULL)
	{
		printk(KERN_INFO "cannot allocate the tasklet memory\n");
		goto irq;
	}
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Jay");
MODULE_DESCRIPTION("My first tasklet with spinlock Driver");
