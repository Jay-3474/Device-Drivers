...
int main(int argc, char *argv[])
{
	...
	/*this variable holds remaining data bytes to the read*/
	...
	while(n != 2 && remaining)
	{
		...
		else if(ret <= remaining)
		{
			...
			/*ret contains count of data bytes successfully read, so and it to total_read*/
			total_read += ret;
